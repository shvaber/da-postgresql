...
HOOK_FILE="/usr/local/directadmin/scripts/custom/user_backup_compress_pre.sh";
SRC_FILE="/usr/local/directadmin/plugins/postgresql/scripts/setup/user_backup_compress_pre.sh.src";

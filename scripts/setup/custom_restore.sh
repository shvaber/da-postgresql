...
HOOK_FILE="/usr/local/directadmin/scripts/custom/user_restore_post.sh";
SRC_FILE="/usr/local/directadmin/plugins/postgresql/scripts/setup/user_restore_post.sh.src";
